...
- `docs/analise_requisitos_v5.0.md` — RFs, RNFs, RNs, UCs (fonte de verdade única)
- `docs/06_arquitetura_backend.md` — arquitetura e fases de implementação do backend
- `docs/modelagem_sistema_v2.0.md`, `docs/02_diagrama_casos_uso_v3.0.md` — diagramas
...
```python
# Implementa: RF09 (UC08), RF10 (UC10) — ver docs/analise_requisitos_v5.0.md
```
...
docs: atualiza analise_requisitos_v5.0.md — adiciona RN12
