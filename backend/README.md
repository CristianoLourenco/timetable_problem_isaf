...
API FastAPI + motor de otimização Google OR-Tools CP-SAT para geração de horários. Ver `docs/CONVENCOES.md` (arquitetura) e `../docs/06_arquitetura_backend.md` (especificação completa).
